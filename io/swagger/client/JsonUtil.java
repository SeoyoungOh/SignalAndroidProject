...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("InlineResponse4011".equalsIgnoreCase(className)) {
      return new TypeToken<List<InlineResponse4011>>(){}.getType();
    }
    
    if ("InlineResponse410".equalsIgnoreCase(className)) {
      return new TypeToken<List<InlineResponse410>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("InlineResponse4011".equalsIgnoreCase(className)) {
      return new TypeToken<InlineResponse4011>(){}.getType();
    }
    
    if ("InlineResponse410".equalsIgnoreCase(className)) {
      return new TypeToken<InlineResponse410>(){}.getType();
    }
